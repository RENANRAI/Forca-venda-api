// Infra/Integration/Erp/Representantes/RepresentanteErpDto.cs
namespace ForcaVendas.Api.Infra.Integration.Erp.Representantes;

public class RepresentanteErpDto
{
    ...
    public List<RepresentanteParametrosEmpresaErpDto> ParametrosPorEmpresa { get; set; }
        = new();
}
